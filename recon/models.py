...
class ReportType(str, Enum):
    ...
    SAP_MASTER = "sap_master"                # SAP: εταιρείες, κέντρα κόστους, λογαριασμοί
...
REPORT_LABELS = {
    ...
    ReportType.SAP_MASTER: "Βασικά δεδομένα SAP (chart of accounts, cost centres)",
}
