...
όχι από το όνομα αρχείου. Ένα νοσοκομείο και ένας μήνας ανά εκτέλεση. Το SRA συχνά
φέρει ημερομηνία του επόμενου μήνα (η ΟΑΥ πληρώνει με καθυστέρηση) — αναγνωρίζεται
και αντιστοιχίζεται αυτόματα στον μήνα υπηρεσιών.*
"""
