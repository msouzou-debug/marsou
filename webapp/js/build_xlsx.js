...
function sapHeader(ws) {
  ...
  ws.getCell(1, 25).value = 'Ιατρός / Επαγγελματίας (Professional)';
...
function journalLines(section, lookup) {
  /* One provider unit's credit lines, ordered by cost centre, internal order,
   * then professional — the order the service's own journal uses.
   *
