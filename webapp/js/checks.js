...
function buildSplit(bundle) {
   ...
   * left is outpatient.  Nothing is invented — the three add back to the SRA
   * line, so the bucket and the cheque are untouched. */
  let pdRest = sraAmount(['PD']);
  ...
  } else if (!pdCap && pdRest && capReport) {
