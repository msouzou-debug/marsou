...
const entry: PreviewEntry = {
  ...
  notes:
    "Two bars in the default panel: the first is inside budget, the second shows " +
    ...
    "there so the rule survives greyscale print. No permission and offline are " +
    "skipped: the bar holds no controls and no writes, so offline shows the cached " +
    "figures unchanged and access is decided by the screen that renders it.",
};
