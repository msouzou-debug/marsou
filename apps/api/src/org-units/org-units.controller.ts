...
export class OrgUnitsController {
   ...
   * Administration carries all twelve ids and therefore sees all twelve.
   */
  @Get()
  @ApiOperation({ summary: "The org units the caller may see" })
  @ApiZodResponse(200, z.array(OrgUnit), "Twelve units for a central user, fewer for everyone else")
