...
| `src/db/seed-data.ts` | The twelve units (HQ added 19/09/2026, the Ambulance Service removed the same day — ADR-0024; Community Nursing added 20/09/2026 — ADR-0024's addendum) and their source spellings, one seeded building, eight users, the group→role mappings, the 41 fixture projects and the twelve fixture contractors. |
