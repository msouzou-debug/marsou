...
- **Name matches eArchive's folder — owner decision, 21/09/2026.** 0018 opened the unit as «Κοινοτική Νοσηλευτική Υπηρεσία» / "Community Nursing Service". eArchive's folder reads «Κοινοτική Νοσηλευτική» (Φ. ΤΥ.12), and the owner asked that the two match word for word. Migration `0019_cns_name_matches_earchive.sql` renames the row idempotently on a database 0018 has already run on; the seed, mocks and tests carry «Κοινοτική Νοσηλευτική» / "Community Nursing" directly.
